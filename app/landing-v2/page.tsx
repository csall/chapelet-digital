...
export default function LandingV2() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-[#05070a] text-slate-100 flex flex-col relative overflow-hidden font-sans select-none selection:bg-indigo-500/30">

            {/* ── BACKGROUND ORCHESTRATION ────────────────── */}
            <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_50%_50%,_rgba(6,78,59,0.15)_0%,_rgba(5,7,10,1)_100%)]">
                {/* Animated Nebulas */}
                <motion.div
                    animate={{
                        opacity: [0.2, 0.4, 0.2],
                ...
                <motion.div
                    ...
                    className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-yellow-900/10 blur-[100px]"
                />
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center bg-transparent backdrop-blur-sm">
                ...
                >
                    <div className="w-9 h-9 rounded-lg glass-premium flex items-center justify-center border border-white/10 shadow-lg">
                        <Sparkles size={18} className="text-emerald-400" />
                    </div>
                    <span className="font-extrabold text-lg tracking-tight">Chapelet <span className="text-emerald-500">Digital</span></span>
                </motion.div>
                    ...
                    >
                        ...
                        >
                            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-none mb-4">
                                Sublimez votre <br />
                                <span className="bg-gradient-to-r from-emerald-400 via-yellow-200 to-emerald-400 bg-clip-text text-transparent">Dhikr</span>
                            </h1>
                        ...
                        >
                            <Link
                                ...
                                className="group relative flex items-center justify-center gap-3 bg-white text-slate-950 px-8 py-4 rounded-2xl font-black text-lg transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(16,185,129,0.2)]"
                            >
