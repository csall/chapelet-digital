          ...
          >
            ...
            <div className="w-full flex items-center justify-center pointer-events-auto">
              <div
                ...
                className="flex items-center gap-1 p-1.5 rounded-2xl bg-white/[0.06] border border-white/[0.08] backdrop-blur-2xl"
              >
                <button
                  onClick={toggleSound}
                  aria-label={soundEnabled ? "Désactiver le son" : "Activer le son"}
                  aria-pressed={soundEnabled}
                  className={`w-11 h-11 flex items-center justify-center rounded-[14px] transition-all active:scale-95 ${soundEnabled ? 'bg-white/10 text-white' : 'text-white/30'}`}
                >
                ...
                <motion.button
                  ...
                  className="flex items-center justify-center w-11 h-11 rounded-[14px] bg-white/10 text-white/80 transition-all active:bg-white/20"
                >
                ...
                <button
                  ...
                  className={`w-11 h-11 flex items-center justify-center rounded-[14px] transition-all active:scale-95 ${hapticsEnabled ? 'bg-white/10 text-white' : 'text-white/30'}`}
                >
